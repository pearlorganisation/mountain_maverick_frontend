  ...
  const contactMethods = [
    {
      ...
      contact: `info@mountainmavericks.in
join us
`
    },
    {
    ...
    },
    {
      ...
      contact: `Rawat Arts, Majri Mafi,
Mohkampur, Dehradun, Uttarakhand
Pin 248001`
    },
    {
      title: 'Branch Office',
      ...
      contact: `Hotel Rudraksh
Indira Gandhi Marg, Saharanpur Road Opposite, Niranjanpur Sabzi Mandi, Dehradun, Uttarakhand
Pin 248001`
    },
  ];
        ...
        <div className="max-w-lg mx-auto gap-12 justify-between lg:flex lg:max-w-none">
          ...
          <div className="flex-1 mt-12 sm:max-w-lg lg:max-w-md">
            <form onSubmit={handleSubmit(onSubmit)} className="space-y-5">
              ...
              <button
                type="submit"
                className="w-full px-4 py-2 text-white font-medium bg-green-500 hover:bg-indigo-500 active:bg-green-500 rounded-lg duration-150"
              >
                Submit
              </button>
            </form>
